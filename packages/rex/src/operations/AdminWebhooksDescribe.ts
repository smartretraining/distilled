...
// Input Schema
export const AdminWebhooksDescribeInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    include_detail: Schema.optional(Schema.Boolean),
  }).pipe(T.Http({ method: "POST", path: "/v1/rex/AdminWebhooks::describe" }));
export type AdminWebhooksDescribeInput = typeof AdminWebhooksDescribeInput.Type;

// Output Schema
export const AdminWebhooksDescribeOutput =
...
export type AdminWebhooksDescribeOutput =
  typeof AdminWebhooksDescribeOutput.Type;

// The operation
/**
 * Describes the class and its methods - simply or in detail
 */
export const AdminWebhooksDescribe = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: AdminWebhooksDescribeInput,
    outputSchema: AdminWebhooksDescribeOutput,
  }),
);
