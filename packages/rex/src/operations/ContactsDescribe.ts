...
// Input Schema
export const ContactsDescribeInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  include_detail: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Contacts::describe" }));
export type ContactsDescribeInput = typeof ContactsDescribeInput.Type;

// Output Schema
export const ContactsDescribeOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
...
export type ContactsDescribeOutput = typeof ContactsDescribeOutput.Type;

// The operation
/**
 * Describes the class and its methods - simply or in detail
 */
export const ContactsDescribe = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ContactsDescribeInput,
  outputSchema: ContactsDescribeOutput,
}));
