...
// Input Schema
export const ContactsDescribeModelInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}).pipe(
    T.Http({ method: "POST", path: "/v1/rex/Contacts::describeModel" }),
  );
export type ContactsDescribeModelInput = typeof ContactsDescribeModelInput.Type;

// Output Schema
export const ContactsDescribeModelOutput =
...
export type ContactsDescribeModelOutput =
  typeof ContactsDescribeModelOutput.Type;

// The operation
/**
 * Describes certain characteristics of the model including searchable fields, orderby fields and delete modes
 */
export const ContactsDescribeModel = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ContactsDescribeModelInput,
    outputSchema: ContactsDescribeModelOutput,
  }),
);
