...
// Input Schema
export const ContactsReadInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.Number,
...
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Contacts::read" }));
export type ContactsReadInput = typeof ContactsReadInput.Type;

// Output Schema
export const ContactsReadOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
    ...
    smart_categories: Schema.optional(
...
export type ContactsReadOutput = typeof ContactsReadOutput.Type;

// The operation
/**
 * Read a record by id
 */
export const ContactsRead = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ContactsReadInput,
  outputSchema: ContactsReadOutput,
}));
