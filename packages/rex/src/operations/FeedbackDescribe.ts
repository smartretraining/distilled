...
// Input Schema
export const FeedbackDescribeInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  include_detail: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Feedback::describe" }));
export type FeedbackDescribeInput = typeof FeedbackDescribeInput.Type;

// Output Schema
export const FeedbackDescribeOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
...
export type FeedbackDescribeOutput = typeof FeedbackDescribeOutput.Type;

// The operation
/**
 * Describes the class and its methods - simply or in detail
 */
export const FeedbackDescribe = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: FeedbackDescribeInput,
  outputSchema: FeedbackDescribeOutput,
}));
