...
// Input Schema
export const FeedbackDescribeModelInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}).pipe(
    T.Http({ method: "POST", path: "/v1/rex/Feedback::describeModel" }),
  );
export type FeedbackDescribeModelInput = typeof FeedbackDescribeModelInput.Type;

// Output Schema
export const FeedbackDescribeModelOutput =
...
export type FeedbackDescribeModelOutput =
  typeof FeedbackDescribeModelOutput.Type;

// The operation
/**
 * Describes certain characteristics of the model including searchable fields, orderby fields and delete modes
 */
export const FeedbackDescribeModel = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: FeedbackDescribeModelInput,
    outputSchema: FeedbackDescribeModelOutput,
  }),
);
