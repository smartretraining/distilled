...
// Input Schema
export const FeedbackSearchInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Feedback::search" }));
export type FeedbackSearchInput = typeof FeedbackSearchInput.Type;

// Output Schema
export const FeedbackSearchOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
        ...
        Schema.Array(
          Schema.NullOr(
            Schema.Struct({
              ...
              system_approval_status_time: Schema.optional(
              ...
              has_individual_feedback: Schema.optional(
              ...
              listing: Schema.optional(
                Schema.NullOr(
                  Schema.Struct({
                    ...
                    price_advertise_as: Schema.optional(
                      Schema.NullOr(Schema.String),
                    ),
                          ...
                          contact_reln_listing: Schema.optional(
                            Schema.NullOr(
                              Schema.Array(
                                Schema.NullOr(
                                  Schema.Struct({
                                    do_not_contact: Schema.optional(
                                      Schema.Unknown,
                                    ),
                                    id: Schema.optional(
                                      Schema.NullOr(Schema.Number),
                                    ...
                                    contact: Schema.optional(
                                      Schema.NullOr(
                                        Schema.Struct({
                                          ...
                                          fax_number: Schema.optional(
                                            Schema.Unknown,
                                          ),
                                          is_dnd: Schema.optional(
                                            Schema.Unknown,
                                          ),
...
export type FeedbackSearchOutput = typeof FeedbackSearchOutput.Type;

// The operation
/**
 * Perform a search
 */
export const FeedbackSearch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: FeedbackSearchInput,
  outputSchema: FeedbackSearchOutput,
}));
