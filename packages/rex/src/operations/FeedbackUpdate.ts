...
// Input Schema
export const FeedbackUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Feedback::update" }));
export type FeedbackUpdateInput = typeof FeedbackUpdateInput.Type;

// Output Schema
export const FeedbackUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
    ...
    amount_of: Schema.optional(Schema.Unknown),
    number_of_people: Schema.optional(Schema.NullOr(Schema.String)),
    ...
    has_individual_feedback: Schema.optional(Schema.Unknown),
    ...
    _security_user_rights: Schema.optional(
...
export type FeedbackUpdateOutput = typeof FeedbackUpdateOutput.Type;

// The operation
/**
 * Update the record. To remove sub records include the _destroy flag
 */
export const FeedbackUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: FeedbackUpdateInput,
  outputSchema: FeedbackUpdateOutput,
}));
