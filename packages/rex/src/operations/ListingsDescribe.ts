...
// Input Schema
export const ListingsDescribeInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  include_detail: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Listings::describe" }));
export type ListingsDescribeInput = typeof ListingsDescribeInput.Type;

// Output Schema
export const ListingsDescribeOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
            ...
            Schema.NullOr(
              Schema.Struct({
                ...
                openapi: Schema.optional(
                  Schema.NullOr(
                    Schema.Struct({
                      available: Schema.optional(Schema.NullOr(Schema.Boolean)),
...
export type ListingsDescribeOutput = typeof ListingsDescribeOutput.Type;

// The operation
/**
 * Describes the class and its methods - simply or in detail
 */
export const ListingsDescribe = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListingsDescribeInput,
  outputSchema: ListingsDescribeOutput,
}));
