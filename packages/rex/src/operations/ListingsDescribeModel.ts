...
// Input Schema
export const ListingsDescribeModelInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}).pipe(
    T.Http({ method: "POST", path: "/v1/rex/Listings::describeModel" }),
  );
export type ListingsDescribeModelInput = typeof ListingsDescribeModelInput.Type;

// Output Schema
export const ListingsDescribeModelOutput =
...
export type ListingsDescribeModelOutput =
  typeof ListingsDescribeModelOutput.Type;

// The operation
/**
 * Describes certain characteristics of the model including searchable fields, orderby fields and delete modes
 */
export const ListingsDescribeModel = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListingsDescribeModelInput,
    outputSchema: ListingsDescribeModelOutput,
  }),
);
