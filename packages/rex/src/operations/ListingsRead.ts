...
// Input Schema
export const ListingsReadInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.Unknown,
  fields: Schema.optional(Schema.Array(Schema.Unknown)),
  extra_fields: Schema.optional(Schema.Array(Schema.Unknown)),
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Listings::read" }));
export type ListingsReadInput = typeof ListingsReadInput.Type;

// Output Schema
export const ListingsReadOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
...
export type ListingsReadOutput = typeof ListingsReadOutput.Type;

// The operation
/**
 * Read a record by id
 */
export const ListingsRead = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListingsReadInput,
  outputSchema: ListingsReadOutput,
}));
