...
// Input Schema
export const ListingsUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Listings::update" }));
export type ListingsUpdateInput = typeof ListingsUpdateInput.Type;

// Output Schema
export const ListingsUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
    ...
    lead_auto_response_template: Schema.optional(
      Schema.NullOr(
        Schema.Struct({
          _template_medium: Schema.optional(Schema.NullOr(Schema.String)),
          _template_name: Schema.optional(Schema.NullOr(Schema.String)),
...
export type ListingsUpdateOutput = typeof ListingsUpdateOutput.Type;

// The operation
/**
 * Update the record. To remove sub records include the _destroy flag
 */
export const ListingsUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListingsUpdateInput,
  outputSchema: ListingsUpdateOutput,
}));
