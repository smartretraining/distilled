...
// Input Schema
export const PropertiesDescribeInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    include_detail: Schema.optional(Schema.Boolean),
  }).pipe(T.Http({ method: "POST", path: "/v1/rex/Properties::describe" }));
export type PropertiesDescribeInput = typeof PropertiesDescribeInput.Type;

// Output Schema
export const PropertiesDescribeOutput =
...
export type PropertiesDescribeOutput = typeof PropertiesDescribeOutput.Type;

// The operation
/**
 * Describes the class and its methods - simply or in detail
 */
export const PropertiesDescribe = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PropertiesDescribeInput,
  outputSchema: PropertiesDescribeOutput,
}));
