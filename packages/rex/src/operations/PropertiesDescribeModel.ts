...
// Input Schema
export const PropertiesDescribeModelInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}).pipe(
    T.Http({ method: "POST", path: "/v1/rex/Properties::describeModel" }),
  );
export type PropertiesDescribeModelInput =
  typeof PropertiesDescribeModelInput.Type;

// Output Schema
export const PropertiesDescribeModelOutput =
...
export type PropertiesDescribeModelOutput =
  typeof PropertiesDescribeModelOutput.Type;

// The operation
/**
 * Describes certain characteristics of the model including searchable fields, orderby fields and delete modes
 */
export const PropertiesDescribeModel = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PropertiesDescribeModelInput,
    outputSchema: PropertiesDescribeModelOutput,
  }),
);
