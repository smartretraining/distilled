...
// Input Schema
export const PropertiesUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
    ...
    attr_exterior_id: Schema.optional(Schema.NullOr(Schema.Number)),
    attr_roof_id: Schema.optional(Schema.NullOr(Schema.Number)),
...
}).pipe(T.Http({ method: "POST", path: "/v1/rex/Properties::update" }));
export type PropertiesUpdateInput = typeof PropertiesUpdateInput.Type;

// Output Schema
export const PropertiesUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.NullOr(
  Schema.Struct({
...
export type PropertiesUpdateOutput = typeof PropertiesUpdateOutput.Type;

// The operation
/**
 * Update the record. To remove sub records include the _destroy flag
 */
export const PropertiesUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PropertiesUpdateInput,
  outputSchema: PropertiesUpdateOutput,
}));
